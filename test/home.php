...
<h2 style="margin-top:70px;text-align:center;font-weight:400">Не найдено</h2>
	...
	<div class="buttons">
	    	<a href-data="home.php" class="a1 active"><button><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#02b478"><path d="M0 0h24v24H0z" fill="none"/><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg></button></a>
