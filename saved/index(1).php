...
<meta property="og:url" content="http://learnpearls.ru">
...
if(isset($_COOKIE['name']) and !empty($_COOKIE['name']) and $_COOKIE['name'] != ''){
...
include($_SERVER['DOCUMENT_ROOT'] . "/darkstyles.php");
$month = date("n");
...
if (hour >= 4 && hour < 12 && day != 6)
   {$(".welcome").html("Доброе утро👋<?php echo $name;?>!");}
else if (hour >= 12 && hour < 17 && day !=6)
   {$(".welcome").html("Добрый день☀️<?php echo $name;?>!");}

else if (hour >= 17 && hour < 22 && day != 6)
   {$(".welcome").html("Добрый вечер👋<?php echo $name; ?>!");}
else if (hour >= 22 && hour <=24 && day != 6)
   {$(".welcome").html("Доброй ночи🌙<?php echo $name;?>.");}
else if (hour >= 0 && hour <4 && day != 6)
   {$(".welcome").html("Доброй ночи🌙<?php echo $name;?>.");}
else if (day = 6)
   {$(".welcome").html("С Субботним Днём<?php echo $name;?>!");}
</script>
...
var day=d.getDate();
if(day>=26&&month==9 && day<= 30){
$(".maincart").html(all.a2020313);
}
else if(day>=1&&month==10 && day<= 2){
$(".maincarat").html(all.a2020313);
}
else if(day>=3&&month==10 && day<=9){
$(".maincarta").html(all.a202041);
}
else if(day>=10&&month==10 && day<=16){
$(".maincarat").html(all.a202042);
}
else if(day>=17&&month==10 && day<=23){
$(".maincarat").html(all.a202043);
}
</script>
...
?>имя</p></a>
	...
	<div class="dop_block-mini"></div></div></section>
	<div class="buttons">
...
var data_name_dop = data_name;
  ...
  var expireTime2 = time2 + 1000*36000;
...
var inSlide = $("[week-number=" + weekofyear + "]").attr('data-id');
</script>
<script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
<script>
