...
<section class="page">
	<div class="header">
		<p class="notmargin">Ошибка</p>
		
	</div>
<h2 style="margin-top:75px;text-align:center;font-weight:400;font-size: 1.6em;margin-bottom: 0px;">Не найдено</h2><div class="404image" style="width:125vw;height:auto;margin:auto;margin-left: -12.5vw;margin-top:5px;"><img src="/4042.svg" style="width:125vw"></div>
